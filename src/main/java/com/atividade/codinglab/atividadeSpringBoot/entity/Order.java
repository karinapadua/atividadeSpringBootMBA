package com.atividade.codinglab.atividadeSpringBoot.entity;
...
public class Order {
    ...
    public Order(int id, String email, String nomeCompleto, String address, int idPedido, List<String> descricao,
