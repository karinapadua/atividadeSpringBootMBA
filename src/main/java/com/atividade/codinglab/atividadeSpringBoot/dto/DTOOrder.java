package com.atividade.codinglab.atividadeSpringBoot.dto;
...
public class DTOOrder {
    ...
    public DTOOrder(String email, String nomeCompleto, String address, int idPedido, List<String> descricao,
